...
public class Slf4jReporterJsonFormatTest {
    private final Logger logger = mock(Logger.class);
    private final Marker marker = mock(Marker.class);
    private final MetricRegistry registry = mock(MetricRegistry.class);
    private final Slf4jReporter infoReporterJson= Slf4jReporter.forRegistry(registry)
            .outputTo(logger)
            .markWith(marker)
            .prefixedWith("prefix")
            ...
            .countFormat("{\"type\": \"{}\", \"name\": \"{}\",\"count\": \"{}\"}")
            .timerFormat("{\"type\": \"{}\", \"name\":\"{}\","
            		+ "\"count\":\"{}\", \"min\":\"{}\","
            		+ "\"max\":\"{}\", \"mean\":\"{}\","
            		+ "\"stddev\":\"{}\",\"median\":\"{}\","
            		+ "\"p75\":\"{}\", \"p95\":\"{}\","
            ...
            .meterFormat("{\"type\":\"{}\", \"name\":\"{}\", \"count\":\"{}\", \"mean_rate\":\"{}\", \"m1\":\"{}\", \"m5\":\"{}\", \"m15\":\"{}\", \"rate_unit\":\"{}\"}")
            .histogramFormat("{\"type\":\"{}\", \"name\":\"{}\", \"count\":\"{}\", \"min\":\"{}\", \"max\":\"{}\", \"mean\":\"{}\","
            		+ " \"stddev\":\"{}\", \"median\":\"{}\", \"p75\":\"{}\", \"p95\":\"{}\", \"p98\":\"{}\", \"p99\":\"{}\", \"p999\":\"{}\"}")
            .gaugeFormat("{\"type\":\"{}\", \"name\":\"{}\", \"value\":\"{}\"}")
    ...
    public void reportsGaugeValues() throws Exception {
        ...
        infoReporterJson.report(map("gauge", gauge("value")),
                this.<Counter>map(),
                this.<Histogram>map(),
                this.<Meter>map(),
                this.<Timer>map());
    ...
    public void reportsCounterValues() throws Exception {
        ...
        infoReporterJson.report(this.<Gauge>map(),
