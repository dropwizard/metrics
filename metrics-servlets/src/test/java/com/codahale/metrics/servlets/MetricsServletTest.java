...
public class MetricsServletTest extends AbstractServletTest {
    ...
    protected void setUp(ServletTester tester) {
        ...
        tester.addServlet(MetricsServlet.class, "/metrics").setInitParameter(
                "com.codahale.metrics.servlets.MetricsServlet.allowedOrigin", "*");
    }
    ...
    public void setUp() throws Exception {
        ...
        registry.register("t", new Timer(new ExponentiallyDecayingReservoir(), clock)).update(1, TimeUnit.SECONDS);
    ...
    public void optionallyPrettyPrintsTheJson() throws Exception {
        ...
        assertThat(response.getContent()).isEqualTo(
                String.format("{%n" + "  \"version\" : \"3.0.0\",%n" + "  \"gauges\" : {%n" + "    \"g1\" : {%n"
                        + "      \"value\" : 100%n" + "    }%n" + "  },%n" + "  \"counters\" : {%n" + "    \"c\" : {%n"
                        + "      \"count\" : 1%n" + "    }%n" + "  },%n" + "  \"histograms\" : {%n" + "    \"h\" : {%n"
                        + "      \"count\" : 1,%n" + "      \"max\" : 1,%n" + "      \"mean\" : 1.0,%n"
                        + "      \"min\" : 1,%n" + "      \"p50\" : 1.0,%n" + "      \"p75\" : 1.0,%n"
                        + "      \"p95\" : 1.0,%n" + "      \"p98\" : 1.0,%n" + "      \"p99\" : 1.0,%n"
                        + "      \"p999\" : 1.0,%n" + "      \"stddev\" : 0.0%n" + "    }%n" + "  },%n"
                        + "  \"meters\" : {%n" + "    \"m\" : {%n" + "      \"count\" : 1,%n"
                        + "      \"m15_rate\" : 0.0,%n" + "      \"m1_rate\" : 0.0,%n" + "      \"m5_rate\" : 0.0,%n"
                        + "      \"mean_rate\" : 3333333.3333333335,%n" + "      \"units\" : \"events/second\"%n"
                        + "    }%n" + "  },%n" + "  \"timers\" : {%n" + "    \"t\" : {%n" + "      \"count\" : 1,%n"
                        + "      \"max\" : 1.0,%n" + "      \"mean\" : 1.0,%n" + "      \"min\" : 1.0,%n"
                        + "      \"p50\" : 1.0,%n" + "      \"p75\" : 1.0,%n" + "      \"p95\" : 1.0,%n"
                        + "      \"p98\" : 1.0,%n" + "      \"p99\" : 1.0,%n" + "      \"p999\" : 1.0,%n"
                        + "      \"stddev\" : 0.0,%n" + "      \"m15_rate\" : 0.0,%n" + "      \"m1_rate\" : 0.0,%n"
                        + "      \"m5_rate\" : 0.0,%n" + "      \"mean_rate\" : 1.0E7,%n"
                        + "      \"duration_units\" : \"seconds\",%n" + "      \"rate_units\" : \"calls/second\"%n"
                        + "    }%n" + "  }%n" + "}"));
