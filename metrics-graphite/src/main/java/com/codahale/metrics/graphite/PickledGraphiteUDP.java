...
public final class PickledGraphiteUDP implements GraphiteSender {
    ...
    private final List<GraphitePickler.MetricTuple> metrics = new LinkedList<GraphitePickler.MetricTuple>();
