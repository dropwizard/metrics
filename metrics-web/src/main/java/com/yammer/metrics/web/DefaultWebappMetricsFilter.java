...
/**
 * Implementation of the {@link WebappMetricsFilter} which provides a default set of response codes to capture information about.
 * 
...
public class DefaultWebappMetricsFilter extends WebappMetricsFilter {
    ...
    private static Map<Integer, String> createMeterNamesByStatusCode() {
        Map<Integer, String> meterNamesByStatusCode = new HashMap<Integer, String>();
