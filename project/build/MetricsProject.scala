...
class MetricsProject(info: ProjectInfo) extends ParentProject(info) with IdeaProject {
...
//class DerpMetricsProject(info: ProjectInfo) extends DefaultProject(info)
...
//   */
//  val jackson = "org.codehaus.jackson" % "jackson-mapper-asl" % "1.7.5" % "optional"
//  val servletApi = "javax.servlet" % "servlet-api" % "2.5" % "optional"
//  val jetty = "org.eclipse.jetty" % "jetty-server" % "7.4.0.v20110414" % "optional"
//  val com.yammer.metrics.guice = "com.google.inject" % "com.yammer.metrics.guice" % "3.0" % "optional"
//
//  /**
//   * Test Dependencies
//   */
