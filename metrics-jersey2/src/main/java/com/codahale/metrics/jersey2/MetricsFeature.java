...
/**
 * A {@link Feature} which registers a {@link MetricsApplicationEventListener} for recording request events.
 */
public class MetricsFeature implements Feature {
    ...
    public boolean configure(FeatureContext context) {
        context.register(new MetricsApplicationEventListener(registry));
        return true;
    }
}
