...
public class MetricsServletProvider implements Provider<MetricsServlet>
{
    ...
    public MetricsServlet get()
    {
        ...
        if (jsonFactory != null) {
            return new MetricsServlet(metricsRegistry, healthCheckRegistry, jsonFactory, healthcheckUri, metricsUri, pingUri, threadsUri);
        }
        else {
            return new MetricsServlet(metricsRegistry, healthCheckRegistry, healthcheckUri, metricsUri, pingUri, threadsUri);
        }
    }
}
