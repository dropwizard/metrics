...
public abstract class ElasticsearchReporter extends ScheduledReporter {
	...
	protected ElasticsearchReporter(MetricRegistry registry, Clock clock, String elasticsearchIndexPrefix, String timestampFieldName, String metricPrefix, TimeUnit rateUnit, TimeUnit durationUnit, MetricFilter filter) {
    ...
    private void reportHistogram(String index, long timestamp, String name, Histogram histogram) throws IOException {
		StringWriter writer = new StringWriter();
		JsonGenerator jsonGenerator = jsonFactory.createGenerator(writer);
		jsonGenerator.writeStartObject();
		jsonGenerator.writeNumberField(timestampFieldName, timestamp);
    ...
    protected abstract void addReportToBulkRequest(String index, String type, String json) throws IOException;
